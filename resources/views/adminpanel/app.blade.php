...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('mazher/dist/assets/images/logo/favicon.svg')}}" type="image/x-icon">
        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="index.html"><img src="{{asset('mazher/dist/assets/images/logo/logo.svg')}}" alt="Logo" srcset=""></a>
                    </div>
...
<script src="{{asset('mazher/dist/assets/js/app.js')}}"></script>

<script src="{{asset('mazher/dist/assets/js/pages/dashboard.js')}}"></script>
