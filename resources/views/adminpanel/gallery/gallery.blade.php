            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{route('createGallery')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" id="formFileMultiple" name="path" multiple>
                                    </div>
