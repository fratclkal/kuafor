...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="{{asset('homepage/images/favicon.ico')}}" type="image/x-icon">
    <!-- Stylesheets-->
    ...
    <!--[if lt IE 10]>
    <div style="background: #212121; padding: 10px 0; box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3); clear: both; text-align:center; position: relative; z-index:1;"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="{{asset('homepage/images/ie8-panel/warning_bar_0000_us.jpg')}}" border="0" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    <script src="{{asset('homepage/js/html5shiv.min.js')}}"></script>
    <![endif]-->
</head>
<body>
<div class="page">
    <main class="page-content" id="perspective">
        <div class="content-wrapper">
            <div class="page-header page-header-perspective">
                <div class="page-header-left"><a class="brand" href="index.html"><img src="{{asset('homepage/images/logo-default-dark-200x36.png')}}" alt="" width="200" height="36"/></a></div>
                <div class="page-header-right">
                    <div class="booking-control"><a class="btn btn-xs btn-circle btn-primary" href="step-1.html">Randevu Al</a></div>
                ...
                <footer class="page-footer page-footer-default">
                    <div class="shell">
                        <div class="range range-xs-center">
                            <div class="cell-lg-10"><a class="brand" href="index.html"><img src="{{asset('homepage/images/logo-default-dark-200x36.png')}}" alt="" width="200" height="36"/></a>
                                <div class="text-highlighted-wrap">
                                    <p class="text-highlighted"> SinanSalim Kuaför dükkanı, Batman'da erkek saç kesimi için 1 numaralı yerdir. Burada makul bir fiyata lüks berber deneyimi yaşayabilirsiniz.</p>
                                </div>
                                <ul class="footer-navigation footer-navigation-horizontal">
                                    ...
                                    <li class="active"><a href="contacts-1.html">İletişim</a></li>
                                </ul>
            ...
            <nav class="rd-navbar rd-navbar-default" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-sm-device-layout="rd-navbar-fixed" data-md-layout="rd-navbar-sidebar" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-sidebar" data-stick-up-clone="false">
                <div class="rd-navbar-inner">
                    <div class="rd-navbar-panel">
                        ...
                        <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img src="{{asset('homepage/images/logo-default-dark-200x36.png')}}" alt="" width="200" height="36"/></a></div>
                    </div>
                            ...
                            <ul class="rd-navbar-nav">
                                <li><a href="index.html">Ana Sayfa</a>
                                    <ul class="rd-navbar-megamenu">
                                        <li>
                                            <p class="rd-megamenu-header"><a href="index.html">Ana Sayfa</a></p>
                                            <ul class="rd-megamenu-list">
                                                <li><a href="home-variant-2.html">Home variant 2</a></li>
                                                <li><a href="home-variant-3.html">Home variant 3</a></li>
                                            </ul>
                                            <p class="rd-megamenu-header"><a href="about.html">Hakkımızda</a></p>
                                            <ul class="rd-megamenu-list">
                                                <li><a href="barbers.html">barbers</a></li>
                                                <li><a href="testimonials.html">Testimonials</a></li>
                                                <li><a href="faq.html">FAQ</a></li>
                                            </ul>
                                            <p class="rd-megamenu-header">İletişim</p>
                                            <ul class="rd-megamenu-list">
                                        ...
                                        <li>
                                            <p class="rd-megamenu-header">Randevu Al</p>
                                            <ul class="rd-megamenu-list">
                                ...
                                <li><a href="services.html">Randevu Al</a>
                                </li>
                                ...
                                <li class="active"><a href="#">İletişim</a>
                                    <ul class="rd-navbar-dropdown">
...
<script src="{{asset('homepage/js/core.min.js')}}"></script>
