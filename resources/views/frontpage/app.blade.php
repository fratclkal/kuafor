...
<div class="page">
                ...
                <div class="rd-navbar-inner">
                    <div class="rd-navbar-panel">
                        ...
                        <div class="rd-navbar-brand"><a class="brand-name" href="index.html">
                                <div class="brand-mobile"><img src="{{asset('homepage/images/logo-default-dark-200x36.png')}}" alt="" width="200" height="36"/>
                                </div>
                                <div class="brand-desktop"><img src="{{asset('homepage/images/logo-big-dark-125x125.png')}}" alt="" width="125" height="125"/>
                                </div></a></div>
                    </div>
    ...
    <section class="jumbotron-custom jumbotron-custom-3 bg-white bg-image bg-image-custom bg-image-center" style="background-image: url({{asset('homepage/images/home-three-1-1920x800.jpg')}});">
...
<div class="modal fade text-center" id="modalWindow" role="dialog">
    <div class="modal-dialog custom-modal-dialog">
        <div class="custom-modal-content">
            ...
            <div class="shell">
                <div class="box-portfolio"><img class="box-portfolio-image" src="{{asset('homepage/images/barbers-single-1-130x130.jpg')}}" alt="" width="130" height="130"/>
